...
fun SwipeableContent(
    ...
    val isSwipeToActionEnabled by Preferences.ENABLE_SWIPE_ACTION.collectAsStateWithLifecycle()
...
fun SwipeableQueueItem(
    ...
    val queueSwipeLeftAction = Preferences.QUEUE_SWIPE_LEFT_ACTION.value
    val queueSwipeRightAction = Preferences.QUEUE_SWIPE_RIGHT_ACTION.value
...
fun SwipeablePlaylistItem(
    ...
    val playlistSwipeLeftAction = Preferences.PLAYLIST_SWIPE_LEFT_ACTION.value
    val playlistSwipeRightAction = Preferences.PLAYLIST_SWIPE_RIGHT_ACTION.value
