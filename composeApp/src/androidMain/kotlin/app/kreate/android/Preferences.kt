...
sealed class Preferences<T>(
    ...
    companion object {
        ...
        val YOUTUBE_VISITOR_DATA by lazy {
            String( credentials, "YouTubeVisitorData", "ytVisitorData", Constants.CHROME_WINDOWS_VISITOR_DATA )
        }
        val YOUTUBE_SYNC_ID by lazy {
            String( credentials, "YouTubeSyncId", "ytDataSyncIdKey", "" )
        }
        val YOUTUBE_COOKIES by lazy {
            String( credentials, "YouTubeCookies", "ytCookie", "" )
        }
        val YOUTUBE_ACCOUNT_NAME by lazy {
            String( credentials, "YouTubeAccountName", "ytAccountNameKey", "" )
        }
        val YOUTUBE_ACCOUNT_EMAIL by lazy {
            String( credentials, "YouTubeAccountEmail", "ytAccountEmailKey", "" )
        }
        val YOUTUBE_SELF_CHANNEL_HANDLE by lazy {
            String( credentials, "YouTubeSelfChannelHandle", "ytAccountChannelHandleKey", "" )
        }
        val YOUTUBE_ACCOUNT_AVATAR by lazy {
            String( credentials, "YouTubeAccountAvatar", "ytAccountThumbnailKey", "" )
        }
        ...
        val DISCORD_ACCESS_TOKEN by lazy {
            String( credentials, "DiscordPersonalAccessToken", "", "" )
        }
        //</editor-fold>
        ...
        fun load( context: Context) {
            ...
            if( !::credentials.isInitialized )
                credentials = context.getSharedPreferences( CREDENTIALS_FILENAME, Context.MODE_PRIVATE )
        }
